...
\begin{multicols}{2}
    ...
    The dataset consists of pathology images categorized into four subtypes: \textbf{Luminal A, Luminal B, HER2(+), and Triple negative}, includes 690 training images and their mask files.
